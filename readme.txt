...
1. ダッシュボードウィジェット — 10項目の診断結果を3段階で一覧表示
2. 改善推奨（recommended）の表示例 — なぜ問題か・どうすべきかを平易な日本語で提示
3. カテゴリAのバージョン鮮度診断 — WordPress本体・PHP・プラグイン更新状況
4. カテゴリBのハードニング設定診断 — 7項目のセキュリティ設定チェック
